...
class XGB(XGBoostModel):
    ...
    def __init__(self, diretorio_modelo: str, diretorio_scaler:str) -> None:
        ...
        self._features_scale = ['coolant','stator_winding','stator_tooth','pm','stator_yoke','ambient']
    ...
    def realiza_previsao(self, dataset) -> float:
        ...
        """
        dataset[self._features_scale] = self._scaler.transform(dataset[self._features_scale])
        result = self.__modelo.predict(dataset)
        return float(result)
